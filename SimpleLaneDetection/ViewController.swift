...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    func captureOutput(
        ...
        let newImage = UIImage(cgImage: quartzImage)
        var imageWithLaneOverlay = newImage;

        if lastImage != nil{
            let imageArray: [UIImage?] = [newImage, lastImage]
            print(imageArray)
            imageWithLaneOverlay = LaneDetectorBridge().detectLane(in:imageArray as [Any])
        }
